...
function FormGestioneDatiPagamento(props){
    ...
    function inserisciDatoPagamento(event){
        ...
        let idUtente = (JSON.parse(window.sessionStorage.getItem("clienteReg"))).IdCliente;
        ...
        try{
            axios.post("utente/utenteAggiungiDatoPagamento", datiPagamento)
            .then((res)=>{
    ...
    <div className="container-fluid" style={{maxWidth:500, paddingBottom:10, alignContent:'center', paddingTop:10,backgroundColor:"#d6d6f5"}}>
            ...
            <h2>Modifica i tuoi dati pagamento</h2>
            </div>
    ...
    <Row className="mb-3">
        ...
        <Form.Group as={Col} controlId="meseScad" >
...
export default FormGestioneDatiPagamento;